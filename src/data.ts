...
export const expertise: ExpertiseBlock[] = [
  ...
  {
    title: 'Applied AI, GenAI & ML',
    body:
      'I use AI where it earns its place: LLM-assisted reporting and document workflows, segmentation and forecasting experiments, and classical ML with sensible evaluation—not hype. Comfortable from prototype (Streamlit/Gradio) to patterns that can sit behind real products.',
    tech: [
      'Python',
      'OpenAI API',
      'GPT-4',
