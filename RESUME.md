...
- Power BI dashboards with **15+ KPIs**; integrated **GPT-4** for automated reporting (**~60%** faster reporting cycle).  
...
- Python and **TensorFlow** with **AWS**-centric labs; ETL-style pipelines, model deployment patterns, and **REST** integration for ML services.  
...
**FOAP — Field Officer Platform** · *NestJS, React, Flutter, PostgreSQL, Redis, AWS S3, Socket.IO*  
Production **3-tier SaaS** for field sales: incentives, payroll admin, **offline-first** mobile, GPS via **WebSockets** & Redis, S3-backed verification; **50+** daily field users.
...
**Autonomous Research Agent** · *Python, LangChain, GPT-4, Hugging Face, Gradio*  
...
*Additional repos:* crypto dashboard (React, TypeScript, CatBoost), MERN health platform (JWT, RBAC), Power BI campaign & e-commerce dashboards—see GitHub.
